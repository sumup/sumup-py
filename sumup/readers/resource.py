...
class CreateReaderCheckoutBodyCardType(_OpenStrEnum):
    """
            The card type of the card used for the transaction.
    Is is required only for some countries (e.g: Brazil).
    """

    CREDIT: "CreateReaderCheckoutBodyCardType" = typing.cast(
        "CreateReaderCheckoutBodyCardType", "credit"
    )
    DEBIT: "CreateReaderCheckoutBodyCardType" = typing.cast(
        "CreateReaderCheckoutBodyCardType", "debit"
    )
