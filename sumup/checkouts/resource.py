...
class CreateCheckoutBodyPurpose(_OpenStrEnum):
    """
            Purpose of the checkout.
    Default: "CHECKOUT"
    """

    CHECKOUT: "CreateCheckoutBodyPurpose" = typing.cast("CreateCheckoutBodyPurpose", "CHECKOUT")
    SETUP_RECURRING_PAYMENT: "CreateCheckoutBodyPurpose" = typing.cast(
        "CreateCheckoutBodyPurpose", "SETUP_RECURRING_PAYMENT"
    )


class CreateCheckoutBodyStatus(_OpenStrEnum):
    """
            Current status of the checkout.
    Read only
    """

    FAILED: "CreateCheckoutBodyStatus" = typing.cast("CreateCheckoutBodyStatus", "FAILED")
    PAID: "CreateCheckoutBodyStatus" = typing.cast("CreateCheckoutBodyStatus", "PAID")
    PENDING: "CreateCheckoutBodyStatus" = typing.cast("CreateCheckoutBodyStatus", "PENDING")


class CreateCheckoutBodyTransactionStatus(_OpenStrEnum):
    """
    Current status of the transaction.
    """

    CANCELLED: "CreateCheckoutBodyTransactionStatus" = typing.cast(
        "CreateCheckoutBodyTransactionStatus", "CANCELLED"
    )
    FAILED: "CreateCheckoutBodyTransactionStatus" = typing.cast(
        "CreateCheckoutBodyTransactionStatus", "FAILED"
    )
    PENDING: "CreateCheckoutBodyTransactionStatus" = typing.cast(
        "CreateCheckoutBodyTransactionStatus", "PENDING"
    )
    SUCCESSFUL: "CreateCheckoutBodyTransactionStatus" = typing.cast(
        "CreateCheckoutBodyTransactionStatus", "SUCCESSFUL"
    )


class CreateCheckoutBodyTransactionPaymentType(_OpenStrEnum):
    """
    Payment type used for the transaction.
    """

    BOLETO: "CreateCheckoutBodyTransactionPaymentType" = typing.cast(
        "CreateCheckoutBodyTransactionPaymentType", "BOLETO"
    )
    ECOM: "CreateCheckoutBodyTransactionPaymentType" = typing.cast(
        "CreateCheckoutBodyTransactionPaymentType", "ECOM"
    )
    POS: "CreateCheckoutBodyTransactionPaymentType" = typing.cast(
        "CreateCheckoutBodyTransactionPaymentType", "POS"
    )
    RECURRING: "CreateCheckoutBodyTransactionPaymentType" = typing.cast(
        "CreateCheckoutBodyTransactionPaymentType", "RECURRING"
    )


class CreateCheckoutBodyTransactionEntryMode(_OpenStrEnum):
    """
    Entry mode of the payment details.
    """

    BOLETO: "CreateCheckoutBodyTransactionEntryMode" = typing.cast(
        "CreateCheckoutBodyTransactionEntryMode", "BOLETO"
    )
    CUSTOMER_ENTRY: "CreateCheckoutBodyTransactionEntryMode" = typing.cast(
        "CreateCheckoutBodyTransactionEntryMode", "CUSTOMER_ENTRY"
    )
...
class ProcessCheckoutBodyPaymentType(_OpenStrEnum):
    """
    Describes the payment method used to attempt processing
    """

    BANCONTACT: "ProcessCheckoutBodyPaymentType" = typing.cast(
        "ProcessCheckoutBodyPaymentType", "bancontact"
    )
    BLIK: "ProcessCheckoutBodyPaymentType" = typing.cast("ProcessCheckoutBodyPaymentType", "blik")
    BOLETO: "ProcessCheckoutBodyPaymentType" = typing.cast(
        "ProcessCheckoutBodyPaymentType", "boleto"
    )
    CARD: "ProcessCheckoutBodyPaymentType" = typing.cast("ProcessCheckoutBodyPaymentType", "card")
    IDEAL: "ProcessCheckoutBodyPaymentType" = typing.cast("ProcessCheckoutBodyPaymentType", "ideal")
