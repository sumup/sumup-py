...
class TransactionEvent(pydantic.BaseModel):
    ...
    amount: typing.Optional[_shared.AmountEvent] = None
    """
	Amount of the event.
	"""
    ...
    event_type: typing.Optional[_shared.EventType] = None
    """
	Type of the transaction event.
	"""

    id: typing.Optional[_shared.EventId] = None
    """
    ...
    status: typing.Optional[_shared.EventStatus] = None
    """
	Status of the transaction event.
	"""

    timestamp: typing.Optional[_shared.TimestampEvent] = None
    """
...
class Event(pydantic.BaseModel):
    ...
    transaction_id: typing.Optional[_shared.TransactionId] = None
    """
	Unique ID of the transaction.
	"""

    type: typing.Optional[_shared.EventType] = None
    """
	Type of the transaction event.
	"""
...
class TransactionFull(pydantic.BaseModel):
    ...
    currency: typing.Optional[_shared.Currency] = None
    """
    ...
    entry_mode: typing.Optional[_shared.EntryMode] = None
    """
    ...
    payment_type: typing.Optional[_shared.PaymentType] = None
    """
...
class TransactionHistory(pydantic.BaseModel):
    ...
    card_type: typing.Optional[_shared.CardType] = None
    """
	Issuing card network of the payment card used for the transaction.
	"""
