...
class AccountLegacyType(_OpenStrEnum):
    """
    The role of the user.
    """

    NORMAL: "AccountLegacyType" = typing.cast("AccountLegacyType", "normal")
    OPERATOR: "AccountLegacyType" = typing.cast("AccountLegacyType", "operator")
...
class MerchantSettingsMotoPayment(_OpenStrEnum):
    """
    Whether merchant can make MOTO payments
    """

    ENFORCED: "MerchantSettingsMotoPayment" = typing.cast("MerchantSettingsMotoPayment", "ENFORCED")
    OFF: "MerchantSettingsMotoPayment" = typing.cast("MerchantSettingsMotoPayment", "OFF")
    ON: "MerchantSettingsMotoPayment" = typing.cast("MerchantSettingsMotoPayment", "ON")
    UNAVAILABLE: "MerchantSettingsMotoPayment" = typing.cast(
        "MerchantSettingsMotoPayment", "UNAVAILABLE"
    )
